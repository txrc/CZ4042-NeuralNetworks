...
def main():
    ...
    plt.figure(1)
    plt.plot(range(len(num_neurons)), accuracy)
    plt.xticks(range(len(num_neurons)), num_neurons)
    plt.xlabel('No. Of Neurons')
    plt.ylabel('Test Accuracy')
    plt.title('Test Accuracy vs. No. Of Neurons')
    plt.savefig('./Classification_Q3b_TestAccVsNeurons.png')

    plt.figure(2)
    plt.plot(range(len(num_neurons)), time_update)
    plt.xticks(range(len(num_neurons)), num_neurons)
    plt.xlabel('No. Of Neurons')
    plt.ylabel('Time to Train (ms)')
    plt.title('Time to Train vs. No. Of Neurons')
    plt.savefig('./Classification_Q3b_TimeToTrainVsNeurons.png')
